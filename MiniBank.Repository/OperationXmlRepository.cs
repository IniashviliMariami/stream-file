...
namespace MiniBank.Repository
{
    public class OperationXmlRepository
    {
        ...
        {
            using (StreamWriter dataWriter = new StreamWriter(_filePath))
            {
                ...
                foreach (var op in _operations)
                {
                    ...
                    operationsElement.Add(operationElement);
                }
                var doc = new XDocument(new XDeclaration("1.0", "utf-8", null), operationsElement);
        ...
        private List<Operation> LoadData()
        {
            ...
            using( StreamReader dataReader=new StreamReader(_filePath)) 
            {
